...
//        String s = "test";
//        URL url = new URL("http://nomer-org.website/allukraina/");
//        /* create a new URL and open a connection */
//        URLConnection con = url.openConnection();
//        con.setDoOutput(true);
//
//        /* wrapper the output stream of the connection with PrintWriter so that we can write plain text to the stream */
...
//        parameters.append("firstName=" + URLEncoder.encode(s, "UTF-8"));
//        parameters.append("&");
//        parameters.append("lastName=" + URLEncoder.encode(s, "UTF-8"));
